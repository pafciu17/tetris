...
[![Build Status](https://travis-ci.org/pafciu17/tetris.svg?branch=master)](https://travis-ci.org/pafciu17/tetris) [![Dependency Status](https://david-dm.org/pafciu17/tetris.svg)](https://david-dm.org/pafciu17/tetris) [![devDependency Status](https://david-dm.org/pafciu17/tetris/dev-status.svg)](https://david-dm.org/pafciu17/tetris#info=devDependencies)
...
## Release History
 * 2014-10-11   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)